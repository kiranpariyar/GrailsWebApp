...
<html>
    ...
    <body>
        ...
        <div id="show-tweet" class="content scaffold-show" role="main">
            ...
            <f:display bean="tweet" />
            </ol>
            <g:form resource="${tweet}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${tweet}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
